...
const t_2 = universal(import('__react_static_root__/src/pages/Login.js'), universalOptions)
      t_2.template = '__react_static_root__/src/pages/Login.js'
      
const t_3 = universal(import('__react_static_root__/src/pages/Manifest.js'), universalOptions)
      t_3.template = '__react_static_root__/src/pages/Manifest.js'
      
const t_4 = universal(import('__react_static_root__/src/pages/Visualize.js'), universalOptions)
